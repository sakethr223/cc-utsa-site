...
import rowdylinkImg from "../public/img/rowdylink.png";
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Welcome to console cowboys
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              We are a UTSA student organization focusing on Low level secure,
              Like Hardware / electrical, Software Reverse engineering, physical
              security, Science, and physics as well. We are a club open to all
              degrees, and we have 80+ club members and growing. We are working
              with CSA and CompTIA. We are branching out to other Organizations
              and Companies for sponsorships
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="flex items-center space-x-2 px-8 py-4 rounded-md"
              ...
              <a
                href="https://discord.gg/ateu4e3zTr"
                target="_blank"
                rel="noopener"
                className="flex items-center space-x-2 bg-indigo-600 px-8 py-4 rounded-md"
              >
                <BsDiscord className="text-white" size={25} />
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Special thanks to the sponsors of our club
          </div>
